...
This plugin provides both instanced and non-instanced animated decal node functionality for all Renderers in Godot 4.4-4.7.1, packaged as an easy-to-use plugin.
...
Summary:
 ...
 - if ANIMATION of decals important = use Godot's default Decal nodes.
